...
# Есть список numbers, реализовать логику в функции get_first_n_last: вернуть новый список состоящий
# из первого и последнего элемента переданного списка
...
def map_keys_and_values(some_keys, some_values):
    ans = {}
    for (x, y) in zip(some_keys, some_values):
        ans[x] = y
    return ans
