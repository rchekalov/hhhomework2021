...
def get_list_without_repetition(some_list):
    ...
    # Если вдруг важно сохранить порядок:
    # list_without_repetition = []
    #     for i in some_list:
    #         if i not in list_without_repetition:
    #             list_without_repetition.append(i)
...
def count_symbols(some_string):
    return {ch: some_string.count(ch) for ch in set(some_string)}